...
4. **If launched headless** (a machine signal, not a human asking for output — `references/headless.md` lists them): load `references/headless.md` and follow it for the whole run. It is the _only_ context where you generate ideas yourself; never load it otherwise.
